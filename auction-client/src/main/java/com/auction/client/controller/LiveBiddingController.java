...
public class LiveBiddingController {
    ...
    private void placeBidOnServer(double bidAmount) {
        bidAmountField.setDisable(true);
        new Thread(() -> {
            PlaceBidResponseDTO response = auctionService.placeBid(currentProduct.getId(), bidAmount);
            Platform.runLater(() -> {
                ...
                if (response != null && response.isSuccess()) {
                    ...
                    ProductDataManager.getInstance().updateAuctionPrice(currentProduct.getId(), bidAmount);
                } else {
