package com.app.common.mapper;// Test khả năng đọc chuỗi role từ DTO (như "SELLER", "ADMIN") để khởi tạo đúng class con (Subclass)
...
@DisplayName("Kiểm thử logic chuyển đổi và phân quyền người dùng của UserMapper")
public class UserMapperTest {
    ...
    @Test
    @DisplayName("toEntity: Role 'seller' (không phân biệt hoa/thường) sinh ra đối tượng Seller")
    ...
    @Test
    @DisplayName("toEntity: Role 'ADMIN' sinh ra đối tượng Admin")
    ...
    @Test
    @DisplayName("toEntity: Role rỗng hoặc không hợp lệ phải tự động fallback về quyền Bidder")
    ...
    @Test
    @DisplayName("toEntity: Trả về null an toàn khi DTO đầu vào bị null")
    ...
    @Test
    @DisplayName("toLoginResponse: Trích xuất đúng tên class (SimpleName) làm Role và map chuẩn dữ liệu")
    ...
    @Test
    @DisplayName("toBalanceResponse: Map chính xác ID, số dư và tạo thông báo chứa username")
    ...
    @Test
    @DisplayName("toSeller: Ép kiểu trực tiếp DTO thành đối tượng Seller")
    ...
    @Test
    @DisplayName("toBidder: Ép kiểu trực tiếp DTO thành đối tượng Bidder")
