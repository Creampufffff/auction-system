package java.com.app.common.mapper;//kiểm tra xem cơ chế ép kiểu đa hình của Java có hoạt động đúng khi bóc tách thông tin bảo hành (warranty) từ một sản phẩm điện tử hay không
